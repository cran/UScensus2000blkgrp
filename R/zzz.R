...
.First.lib <- function(lib, pkg){
    if(R.version$major=="1"){
     ehelp <- help(package="UScensus2000blkgrp")$info[[2]][[2]]
     cat(paste("'",ehelp[4],"'\n",
               "Version ",ehelp[2],
               " created on ",ehelp[3],".\n", sep=""))
    }else{
     ehelp <- help(package="UScensus2000blkgrp")$info[[1]]
    ...
    cat('For citation information, type citation("UScensus2000blkgrp").\n')
    cat('Type help(package="UScensus2000blkgrp") to get started.\n')
}
